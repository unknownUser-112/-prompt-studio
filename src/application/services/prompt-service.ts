...
export class PromptService {
  ...
  renderJson(state: ResolvedState, providers: readonly PromptSectionProvider[], layout: ProfileLayout): JsonPromptResult {
    return this.jsonRenderer.render(this.astBuilder.build(state, providers), layout);
  }
}
