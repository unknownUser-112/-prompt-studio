...
export interface ProjectRepository {
  getById(id: string, transaction?: StorageTransaction): Promise<Result<ProjectRecord | null, StorageError>>;
  list(transaction?: StorageTransaction): Promise<Result<readonly ProjectRecord[], StorageError>>;
