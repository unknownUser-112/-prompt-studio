...
export interface ProjectRevisionRepository {
  getById(id: string): Promise<Result<ProjectRevisionRecord | null, StorageError>>;
  listByProjectId(projectId: string): Promise<Result<readonly ProjectRevisionRecord[], StorageError>>;
